    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div class="center">
                ...
                <img class="topnav-right" src="Images/logo.png">
            <div class="center">
                <h1> שלום ברוכים הבאים לאתר שלי</h1>
                <h2>מועדון הכדורגל ברצלונה הוא מועדון כדורגל מהעיר ברצלונה שבספרד</h2>
                <h3>המועדון נוסד ב-29 בנובמבר 1899 על ידי קבוצת כדורגלנים שווייצרים, בריטים וקטלאנים, בראשות ז'ואן גאמפר</h3>
                <h4>האתר שלי עוסק בברצלונה באתר זה תוכלו לשתף את דעתכם על הקבוצה ולעלות את דעתכם על משחקים ועוד מקווה שתהנו</h4>
                    ...
                    <table class="login">
                        ...
                        <tr>
                            <td><input type="text" placeholder="שם מישתמש"></td>
                        </tr>
                        <tr>
